...
public class UserController {
    ...
    public ResponseEntity<ResponseDTO> addUserInBookStore( @Valid @RequestBody UserDTO userDTO){
       User newUser= userRegistrationService.addUser(userDTO);
   ...
   */
    ...
    {
        List<User> listOfUsers = userRegistrationService.getAllUsers();
    ...
    public ResponseEntity<String> updateUserById(@PathVariable String token,@Valid @RequestBody UserDTO userDTO){
        User entity = userRegistrationService.updateUser(token,userDTO);
    ...
    public User findUserById(@PathVariable int userId){
              return userRegistrationService.findUserById(userId);
    }
