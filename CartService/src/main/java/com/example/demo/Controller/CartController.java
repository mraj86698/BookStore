...
public class CartController {
     ...
     */
    @PostMapping("/addCart")
    public ResponseEntity<ResponseDTO> addItems(@Valid @RequestBody CartDTO request) {
    	System.out.println(request);
        Cart addCart = cartService.addItems(request);
        ResponseDTO responseDTO = new ResponseDTO("User Added to Cart successfully !", addCart);
    ...
    /**
     * To Update the Quantity using user Id and cartId
     * @param token
     * @param cartId
     * @param quantity
     * @return
    ...
    public String updateQuantity(@PathVariable int userId,@PathVariable int cartId,@RequestParam int quantity){
